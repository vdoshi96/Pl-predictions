...
- `/leaderboard` shows table points only, with a maximum of 100. Before reveal, totals remain 0 and spotlight picks stay private. After scoring starts, a compact podium includes everyone at competition ranks 1–3, including all ties. The searchable table shows scores, champion picks, breakdowns, and movement.
