...
- The owner clarified on 2026-08-24 that each underdog and overrated category ranks only the distinct players or clubs picked for that category. Unpicked subjects in standings or factual rating snapshots do not affect opinion-category ranks. Existing immutable snapshots remain unchanged and supply only the facts for picked subjects.
