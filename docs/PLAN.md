...
6. Publish the evidence-only closeout through its own pull request, synchronize final local and remote `main`, reverify the retained handoff digest, and remove the completed feature/closeout branch and worktree state. This cleanup remains pending until the closeout merge succeeds.
