...
Evidence date: 2026-08-14. The current evidence covers the completed August 13 roster/portrait release from local reconciliation through GitHub merge, production deployment, Neon recovery proof, one supported seed, read-only production verification, evidence closeout, and repository cleanup. The completed August 8 how-to, database-time countdown, retained test entry, and fixture-retirement evidence remains below as dated production history.
...
- The superseded QA set and hash-identical output screenshot duplicates moved recoverably to `/Users/vishal/.Trash/Pl-Predictions-superseded-QA-2026-08-14`. The newest seven canonical screenshots remain under `docs/assets/qa/`, and the current output report/results remain retained.
