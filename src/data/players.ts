...
export const PREMIER_LEAGUE_2026_27_PLAYER_COUNT = 587;
export const PREMIER_LEAGUE_2026_27_PLAYER_PORTRAIT_COUNT = 580;
...
if (
  ...
  throw new Error(
    "The active Premier League player fixture must contain 587 players.",
  );
}
