...
### Table-only leaderboard and spotlight accuracy iteration (locally verified; release pending)
...
- Kept the current production deployment and screenshots labelled as prior-release evidence until this branch is merged and receives a new read-only production smoke. No production write ran for this iteration.
